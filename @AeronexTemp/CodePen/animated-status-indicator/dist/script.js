...
animation === 'waiting' && React.createElement("path", { d: "M175.27,152.06s55.19,87.24-65.77,74.44" }),
animation === 'thinking' && React.createElement("path", { d: "M175.93,152.78s-10.18,82-36.43,103.72" }),
animation === 'passive' && React.createElement("path", { d: "M175.93,152.78s-10.18,82-36.43,103.72" }),
animation === 'sleeping' && React.createElement("path", { d: "M175.93,152.78s-10.18,82-36.43,103.72" }));
...
React.createElement("svg", { className: "arm", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 300 400" },
animation === 'typing' && React.createElement("path", { className: "arm-typing-right", d: armPath }),
animation === 'stressed' && React.createElement("path", { className: "arm-typing-right", d: armPath }),
animation === 'waiting' && React.createElement("path", { d: "M207.26,171.26s45.19,85-75.76,72.24" }),
animation === 'thinking' && React.createElement("path", { className: "arm-thinking-right", d: "M207.48,172.34s-76,114.16-93-9.84" }),
animation === 'passive' && React.createElement("path", { d: "M207.93,172c.57-.48,11.3,86.45-23.43,112.52" }),
animation === 'sleeping' && React.createElement("path", { d: "M207.93,172c.57-.48,11.3,86.45-23.43,112.52" }));
...
class App extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      React.createElement("button", { onClick: () => this.setAnimation('passive') }, "Passive"),
      React.createElement("button", { onClick: () => this.setAnimation('waiting') }, "Waiting"),
      React.createElement("button", { onClick: () => this.setAnimation('thinking') }, "Thinking"),
      React.createElement("button", { onClick: () => this.setAnimation('typing') }, "Typing"),
